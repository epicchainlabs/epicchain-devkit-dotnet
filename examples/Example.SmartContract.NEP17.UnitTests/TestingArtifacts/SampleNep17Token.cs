...
public abstract class SampleNep17Token : Chain.SmartContract.Testing.SmartCont, EpicChain.SmartContract.Testing.TestingStandards.INepandard, EpicChain.SmartContract.Testing.TestingStandards.IVerificable, IContractInfo
{
    ...
    public event Chain.SmartContract.Testing.TestingStandards.INep17Standard.delTransfer? OnTransfer;
    ...
    protected SampleNep17Token(Chain.SmartContract.Testing.SmartContractInitialize initialize) : base(initialize) { }
