...
public abstract class SampleNep17Token : ntract.Testing.SmartContmartContract.Testing.TestingStandards.INephain.SmartContract.Testing.TestingStandards.IVerificable, IContractInfo
{
    ...
    public event ntract.Testing.TestingStandards.INep17Standard.delTransfer? OnTransfer;
    ...
    protected SampleNep17Token(ntract.Testing.SmartContractInitialize initialize) : base(initialize) { }
