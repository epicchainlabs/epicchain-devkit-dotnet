...
public abstract class SampleNep17Token : EpicChain.SmartContract.Testing.SmartContract, EpicChain.SmartContract.Testing.TestingStandards.INep17Standard, EpicChain.SmartContract.Testing.TestingStandards.IVerificable, IContractInfo
{
    ...
    protected SampleNep17Token(EpicChain.SmartContract.Testing.SmartContractInitialize initialize) : base(initialize) { }
