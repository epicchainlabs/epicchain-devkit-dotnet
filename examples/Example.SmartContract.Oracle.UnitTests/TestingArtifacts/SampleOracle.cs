...
public abstract class SampleOracle : EpicChain.SmartContract.Testing.SmartContract, IContractInfo
{
    ...
    protected SampleOracle(EpicChain.SmartContract.Testing.SmartContractInitialize initialize) : base(initialize) { }
