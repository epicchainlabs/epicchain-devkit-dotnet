...
public abstract class SampleOracle : ntract.Testing.SmartContract, IContractInfo
{
    ...
    protected SampleOracle(ntract.Testing.SmartContractInitialize initialize) : base(initialize) { }
