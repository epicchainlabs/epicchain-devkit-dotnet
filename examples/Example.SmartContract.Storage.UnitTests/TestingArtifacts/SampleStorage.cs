...
public abstract class SampleStorage : EpicChain.SmartContract.Testing.SmartContract, IContractInfo
{
    ...
    protected SampleStorage(EpicChain.SmartContract.Testing.SmartContractInitialize initialize) : base(initialize) { }
