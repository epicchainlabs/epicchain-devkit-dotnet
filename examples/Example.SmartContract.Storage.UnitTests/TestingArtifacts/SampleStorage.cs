...
public abstract class SampleStorage : ntract.Testing.SmartContract, IContractInfo
{
    ...
    protected SampleStorage(ntract.Testing.SmartContractInitialize initialize) : base(initialize) { }
