...
public abstract class SampleInscription : ntract.Testing.SmartContract, IContractInfo
{
    ...
    protected SampleInscription(ntract.Testing.SmartContractInitialize initialize) : base(initialize) { }
