...
public abstract class SampleZKP : EpicChain.SmartContract.Testing.SmartContract, IContractInfo
{
    ...
    protected SampleZKP(EpicChain.SmartContract.Testing.SmartContractInitialize initialize) : base(initialize) { }
