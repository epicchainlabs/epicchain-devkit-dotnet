...
public abstract class SampleZKP : ntract.Testing.SmartContract, IContractInfo
{
    ...
    protected SampleZKP(ntract.Testing.SmartContractInitialize initialize) : base(initialize) { }
