...
public abstract class SampleLootNFT : Chain.SmartContract.Testing.SmartContract, IContractInfo
{
    ...
    protected SampleLootNFT(Chain.SmartContract.Testing.SmartContractInitialize initialize) : base(initialize) { }
