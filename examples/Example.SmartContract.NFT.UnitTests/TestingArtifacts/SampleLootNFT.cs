...
public abstract class SampleLootNFT : ntract.Testing.SmartContract, IContractInfo
{
    ...
    protected SampleLootNFT(ntract.Testing.SmartContractInitialize initialize) : base(initialize) { }
