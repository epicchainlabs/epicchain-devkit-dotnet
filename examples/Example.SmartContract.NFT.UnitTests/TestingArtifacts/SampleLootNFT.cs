...
public abstract class SampleLootNFT : EpicChain.SmartContract.Testing.SmartContract, IContractInfo
{
    ...
    protected SampleLootNFT(EpicChain.SmartContract.Testing.SmartContractInitialize initialize) : base(initialize) { }
