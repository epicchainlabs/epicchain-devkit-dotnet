...
public abstract class SampleException : ntract.Testing.SmartContract, IContractInfo
{
    ...
    protected SampleException(ntract.Testing.SmartContractInitialize initialize) : base(initialize) { }
