...
public abstract class SampleException : EpicChain.SmartContract.Testing.SmartContract, IContractInfo
{
    ...
    protected SampleException(EpicChain.SmartContract.Testing.SmartContractInitialize initialize) : base(initialize) { }
