...
public abstract class SampleException : Chain.SmartContract.Testing.SmartContract, IContractInfo
{
    ...
    protected SampleException(Chain.SmartContract.Testing.SmartContractInitialize initialize) : base(initialize) { }
