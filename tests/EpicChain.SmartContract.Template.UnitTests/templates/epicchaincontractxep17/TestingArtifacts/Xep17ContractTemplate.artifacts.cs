...
public abstract class Xep17ContractTemplate(EpicChain.SmartContract.Testing.SmartContractInitialize initialize) : EpicChain.SmartContract.Testing.SmartContract(initialize), EpicChain.SmartContract.Testing.TestingStandards.IXep17Standard, EpicChain.SmartContract.Testing.TestingStandards.IOwnable, EpicChain.SmartContract.Testing.TestingStandards.IVerificable, IContractInfo
{
    ...
    public event EpicChain.SmartContract.Testing.TestingStandards.IOwnable.delSetOwner? OnSetOwner;
