...
namespace EpicChain.Compiler.CSharp.UnitTests
{
    ...
    public class UnitTest_DebugInfo
    {
        ...
        {
            var testContractsPath = new FileInfo("../../../../EpicChain.Compiler.CSharp.TestContracts/Contract_Event.cs").FullName;
            ...
            Assert.AreEqual("EpicChain.Compiler.CSharp.TestContracts.Contract_Event,test", (debugInfo["methods"] as JArray)![0]!["name"]!.AsString());
            ...
            Assert.AreEqual("EpicChain.Compiler.CSharp.TestContracts.Contract_Event,Transferred", (debugInfo["events"] as JArray)![0]!["name"]!.AsString());
