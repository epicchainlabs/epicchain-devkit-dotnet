...
namespace EpicChain.Compiler.CSharp.UnitTests
{
    ...
    public class UnitTest_Contract1 : DebugAndTestBase<Contract1>
    {
        ...
        public void Test_PrivateMethod()
        {
            ...
            var testContractsPath = new FileInfo("../../../../EpicChain.Compiler.CSharp.TestContracts/Contract1.cs").FullName;
        ...
        public void Test_ByteArray_New()
        {
            ...
            AssertEpicPulseConsumed(1232070);
        }
        ...
        public void Test_testArgs1()
        {
            ...
            AssertEpicPulseConsumed(1539180);
        }
        ...
        public void Test_testArgs2()
        {
            ...
            AssertEpicPulseConsumed(1047240);
        }
        ...
        public void Test_testArgs3()
        {
            ...
            AssertEpicPulseConsumed(1047750);
            ...
            AssertEpicPulseConsumed(1048440);
        ...
        public void Test_testVoid()
        {
            // No errors
            Contract.TestVoid();
            AssertEpicPulseConsumed(1232010);
        }
    }
}
