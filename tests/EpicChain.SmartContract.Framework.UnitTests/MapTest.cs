...
namespace EpicChain.SmartContract.Framework.UnitTests
{
    ...
    public class MapTest : DebugAndTestBase<Contract_Map>
    {
        ...
        public void TestCount()
        {
            ...
            AssertEpicPulseConsumed(2036820);
        }
        ...
        public void TestByteArray()
        {
            ...
            AssertEpicPulseConsumed(2645550);
        }
        ...
        public void TestClear()
        {
            ...
            AssertEpicPulseConsumed(2646090);
        }
        ...
        public void TestByteArray2()
        {
            ...
            AssertEpicPulseConsumed(3936330);
        }
        ...
        public void TestUnicode()
        {
            ...
            AssertEpicPulseConsumed(2399790);
        }
        ...
        public void TestUnicodeKeyValue()
        {
            ...
            AssertEpicPulseConsumed(2399850);
        }
        ...
        public void TestInt()
        {
            ...
            AssertEpicPulseConsumed(2399580);
        ...
        public void TestDeserialize()
        {
            ...
            AssertEpicPulseConsumed(3874500);
        ...
        public void TestUInt160KeyDeserialize()
        {
            ...
            AssertEpicPulseConsumed(3813360);
