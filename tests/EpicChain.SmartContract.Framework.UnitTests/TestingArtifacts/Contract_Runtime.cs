...
public abstract class Contract_Runtime(EpicChain.SmartContract.Testing.SmartContractInitialize initialize) : EpicChain.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// Unsafe method
    /// </summary>
    [DisplayName("getEpicPulseLeft")]
    public abstract BigInteger? GetEpicPulseLeft();
