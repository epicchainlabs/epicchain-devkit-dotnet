...
public abstract class Contract_SupportedStandard11Enum(EpicChain.SmartContract.Testing.SmartContractInitialize initialize) : EpicChain.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// Unsafe method
    /// </summary>
    [DisplayName("OnXEP11Payment")]
    public abstract void OnXEP11Payment(UInt160? from, BigInteger? amount, string? tokenId, object? data = null);
